...
public class ArsenicVersionDialogController {
    ...
    public ArsenicVersionDialogController(FirmwareVersionDialogFragment dialog) {
        mDialog = dialog;
    ...
    /**
     * Populates the Arsenic version field in the dialog.
     */
    public void initialize() {
        initializeAdminPermissions();

        mDialog.setText(ARSENIC_VERSION_VALUE_ID, SystemProperties.get(ARSENIC_PROPERTY,
